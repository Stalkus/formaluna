 ...
 *
 * Use a static import of the compiled app so Vercel’s Node bundler traces Express,
 * Prisma, and all of `backend/dist`. A dynamic import() skips that tracing and the
 * function often deploys without those files → FUNCTION_INVOCATION_FAILED.
 */
