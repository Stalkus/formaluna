...
async function main() {
  ...
  const demoStudio = {
    ...
    description:
      'An accessible, highly reliable residential downlight by Beneito Faure, perfect for broad residential rollouts.',
    packshotUrl:
      'https://images.unsplash.com/photo-1565814329452-e1efa11c5b89?auto=format&fit=crop&q=80&w=700&h=700',
    lifestyleUrl:
      'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=700&h=700',
  ...
  const demoTrade = {
    ...
    description:
      '48V magnetic track system for commercial specifications with tight UGR controls and rapid click-and-lock mounting.',
    packshotUrl:
      'https://images.unsplash.com/photo-1510074377623-8cf13fb86c08?auto=format&fit=crop&q=80&w=700&h=700',
    lifestyleUrl:
      'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=700&h=700',
